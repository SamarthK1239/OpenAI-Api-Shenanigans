...
- **TrainingAnswerer**: A modern, sleek sidebar GUI application that uses GPT-4 Vision and chat capabilities to help answer training questions from screenshots! Features include screen capture, AI-powered question extraction, context-aware answers using loaded transcripts, and even an **auto-click feature** that automatically clicks the correct answer on screen using OCR. Built with a gorgeous Windows 11-style frosted glass design! (***NEW!***)
